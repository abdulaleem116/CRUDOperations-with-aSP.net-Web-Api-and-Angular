...
namespace CRUD.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            ViewBag.DepartRefID = new SelectList(db.Departments, "DepartID", "DepartName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,LastName,Email,DepartRefID")] Employee employee)
        {
